...
@class FoldViewParagraphStyle;

@interface FoldViewAttributedString : NSObject
...
/** 段落样式 */
@property (nonatomic, copy, readonly) FoldViewParagraphStyle *paragraphStyle;
