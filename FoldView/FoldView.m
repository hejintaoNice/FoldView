...
{
    FoldLabel *_unFoldLabel;        /**< 内容标签 */
    FoldButton *_unFoldButton;      /**< 展开/折叠按钮 */
 ...
 */
- (instancetype)initWithAttributedString:(FoldViewAttributedString *)unFoldAttrStr
 ...
 */
- (void)addSubViewsAndPackSetAttributes:(FoldViewAttributedString *)unFoldAttrStr
                               maxWidth:(CGFloat)maxWidth
                        isDefaultUnFold:(BOOL)isDefaultUnFold
                              foldLines:(NSUInteger)foldLines
                               location:(UnFoldButtonLocation)location
{
    ...
    // 4.行数
    NSUInteger lineCount = [FoldView getLineCountFromAttrStr:contentAttributedString maxWidth:maxWidth];
    ...
    if (_isMutilLine) { // 4.1 有多行
        ...
        if (_isSurpassFoldLine)
        {
            ...
            CGSize unFoldBtnSize = [FoldView attributedStringSize:_buttonUnFoldAttributedString maxWidth:maxWidth];
            CGSize foldBtnSize = [FoldView attributedStringSize:_buttonFoldAttributedString maxWidth:maxWidth];
            ...
            CGRect foldLineRect = [FoldView getLineNumRectFromAttrStr:contentAttributedString lineNum:foldLines isLastLine:NO maxWidth:maxWidth];
            ...
            CGRect unFoldLineRect = [FoldView getLastLineRectFromAttrStr:contentAttributedString maxWidth:maxWidth];
            ...
            if (_isFoldLinesMoreOne) {
                tempContentAttributedString = [FoldView getLineNumBeforeAttrStingFromAttrStr:contentAttributedString lineNum:foldLines deleteStringLength:unFoldAttrStr.unFoldAttributedString.length maxWidth:maxWidth];
                if (unFoldAttrStr.paragraphStyle) {
                    [tempContentAttributedString addAttribute:NSParagraphStyleAttributeName value:unFoldAttrStr.paragraphStyle range:NSMakeRange(0, [tempContentAttributedString length])];
                }
        ...
        {
            // 4.1.3.1 展开的Size
            CGSize unFoldSize = [FoldView attributedStringSize:contentAttributedString maxWidth:maxWidth];
